    ...
    private static final Object[][] contents =
            {
                    {"Билет", " Biljett "},
                    {"id:", " siffra "},
                    {"Билет на:", " Biljett till: "},
                    {"Место:", " En plats: "},
                    {"Дата создания:", " Datum för skapandet: "},
                    {"Цена:", " Pris: "},
                    {"Скидка:", " Rabatt:"},
                    ...
                    {"Ряд:", " Rad: "},
                    {"Название заведения:", " Anläggningsnamn: "},
                    {"Количество мест всего:", " Antal platser totalt: "},
                    {"Вид заведения", " Typ av anläggning "},
                    {"Адрес:", " Adress: "},
                    {"индекс:", " index: "},
                    {"Расположение", " Расположение: "},
                    {"Кордината по x:=", " X-koordinat: = "},
                    {"Кордината по y=", " Y-koordinat = "},
                    {"Кордината по z=", " Koordinera med z = "},
                    ...
                    {"ключ может принимать только целое числовое значение, строго больше нуля", " nyckeln kan bara ta ett heltal numeriskt värde "},
                    {"команды <", " kommandon < "},
