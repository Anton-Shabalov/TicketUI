Клиент-серверное приложение с интерфейсом для клиента. Обмен данными между клиентом и сервером осуществляеться по протоколу TCP, отправляются сериализованные объекты . <br />
